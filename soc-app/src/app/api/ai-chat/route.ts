...
6) MITRE ATT&CK Mapping:
   - When asked to identify confirmed techniques, ONLY list those with DEFINITIVE log evidence (100% certainty).
   - If a technique is suspected but not proven by logs, list it as a "Potential Lead" or "Inference", NOT "Confirmed".
   - You MUST cite the specific log entry (timestamp + action) that proves the technique.
...
========================
${context?.logs ? JSON.stringify(context.logs, null, 2) : 'No logs provided.'}
