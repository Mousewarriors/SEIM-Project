...
interface AlertState {
    ...
    currentInvestigationContext: InvestigationContext | null;
    setInvestigationContext: (ctx: InvestigationContext | null) => void;
}
...
export const useAlertStore = create<AlertState>()(
    persist(
        (set) => ({
            ...
            currentInvestigationContext: null,
            setInvestigationContext: (ctx) => set({ currentInvestigationContext: ctx }),
